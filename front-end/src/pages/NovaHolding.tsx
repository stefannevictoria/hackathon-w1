    ...
    <div className="max-w-4xl mx-auto pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
        ...
        <div>
          ...
          <Input id="integrantes" className="w-full rounded-full" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
        <div>
          ...
          <Textarea id="descricao" className="w-full rounded-lg min-h-[120px]" />
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            <Checkbox id="ativo1" className="mr-2" defaultChecked />
            <label htmlFor="ativo1">Ativo 1</label>
          </div>
          <div className="flex items-center">
            <Checkbox id="ativo2" className="mr-2" />
